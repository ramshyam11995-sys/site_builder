...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
        ...
        <div className="relative z-10 w-32 flex item-center justify-center">
        ...
        <p key={current} className="mt-8 text-lg font-light test-white/90 tracking-wide transition-all duration-700 ease-in-out opacity-100">{steps[current].label}</p>
